...
import { A as invariant, D as resolveManifestCssLink, E as resolveManifestAssetLink, F as isRedirect, I as rootRouteId, L as isNotFound, N as isDangerousProtocol, O as _getRenderedMatches, T as getStylesheetHref, a as isSsrResponse, c as stripSsrResponseBody, f as RouterProvider, i as disposeSsrResponseDetached, k as executeRewriteInput, n as bindSsrResponseToRequest, o as normalizeSsrResponse, r as defineHandlerCallback, s as replaceSsrResponse, t as renderRouterToStream, w as getScriptPreloadAttrs } from "../_libs/@tanstack/react-router+[...].mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CgC7OTTX.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BHLuj73U.mjs").then((n) => n.t),
		import("./start-DO7f0SiO.mjs"),
